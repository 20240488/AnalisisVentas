...
class Program
{
    static void Main()
    {
        ...
        int sourceIdCustomers = DbLoader.InsertDataSource("CSV", "customers.csv");
        int sourceIdProducts = DbLoader.InsertDataSource("CSV", "products.csv");
        int sourceIdOrders = DbLoader.InsertDataSource("CSV", "orders.csv");
        int sourceIdOrderDetails = DbLoader.InsertDataSource("CSV", "order_details.csv");
